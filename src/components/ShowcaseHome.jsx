...
function Showcase() {
  ...
  const [value, setValue] = React.useState(localStorage.getItem("showcaseResourcesContent"));
  ...
  const ff = (event) => {
    ...
    if (style.display != "none") { // user was editing currently
      ...
      if (document.querySelector(".w-md-editor-text") != null) {
        ...
        localStorage.setItem("showcaseResourcesContent", document.querySelector(".w-md-editor-text").innerText);
      }
      // console.log();
