...
function Projects() {
  ...
  const [value, setValue] = React.useState(localStorage.getItem("projectsResourcesContent"));
  ...
  const ff = (event) => {
    ...
    if(style.display != "none"){ // user was editing currently
      ...
      // localStorage.setItem("projectsResourcesContent", document.querySelector(".w-md-editor-text").innerText);
