...
function Links() {
  ...
  const [value, setValue] = React.useState(localStorage.getItem("linksResourcesContent"));
  ...
  const ff = (event) => {
    ...
    if(style.display != "none"){ // user was editing currently
      ...
      if(document.querySelector(".w-md-editor-text") != null){
        ...
        localStorage.setItem("linksResourcesContent", document.querySelector(".w-md-editor-text").innerText);
            }      // console.log();
